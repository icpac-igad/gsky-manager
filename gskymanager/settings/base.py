...
GSKY_CONFIG = {
    ...
    "GSKY_RULESETS_HOST_PATH": env.str("GSKY_RULESETS_HOST_PATH"),
    "GSKY_RULESETS_CONTAINER_PATH": env.str("GSKY_RULESETS_CONTAINER_PATH"),
}

OWS_BASE_URL = env.str("OWS_BASE_URL")

ADS_KEY = env.str("ADS_KEY", "")
